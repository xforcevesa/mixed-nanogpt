...
load(name="wind_backstepping", sources=[f'cuda/wkv7_fp32.cu', 'cuda/wkv7_op_fp32.cpp'], is_python_module=False, verbose=True, extra_cuda_cflags=flags)
