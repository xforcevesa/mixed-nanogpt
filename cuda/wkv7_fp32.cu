...
// Replace bf with float (FP32)
typedef float bf;

__device__ inline float to_float(const bf & u) { return u; }  // FP32, no conversion needed
__device__ inline bf to_bf(const float & u) { return u; }      // FP32, no conversion needed
