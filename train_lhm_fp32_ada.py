...
class CausalSelfAttention(nn.Module):
    ...
    def __init__(self, config):
        ...
        # 
        self.soft_assign = nn.AdaptiveAvgPool1d(config.n_cluster)
    ...
    def long_forward(self, x):
        ...
        ck = self.soft_assign(k.permute(0, 2, 1)).permute(0, 2, 1) # (B, n_cluster, C)
        cv = self.soft_assign(v.permute(0, 2, 1)).permute(0, 2, 1) # (B, n_cluster, C)
...
class GPTConfig:
    ...
    n_cluster: int = 16 # number of clusters
